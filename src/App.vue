<template>
    <div id="app">
        ...
        <div id="accordion">
            <div class="card">
                <div class="card-header" id="headingOne">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#liveEdit" aria-expanded="true" aria-controls="collapseOne">
                            Live Edit
                        </button>
                    </h5>
                </div>
                <div id="liveEdit" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        <live-edit v-model="editField1" :editable="false" placeholder="placeholder on edit" :multiline="false">
                        </live-edit>
                        <hr />
                        Edit field 2 {{ editField2 }}
                        <live-edit v-model="editField2" :editable="false" placeholder="placeholder on edit" :multiline="true">
                        </live-edit>
                    </div>
                </div>
            </div>
        ...
        <AjaxTable :columns="['col1', 'col2']" :rows="[{col1: 'qq', col2:'some data'},{col1: 'qq2', col2:'some moore data'},{col1: 'qq3', col2:'a third data'}, ]"></AjaxTable>
    </div>
</template>
<script>
