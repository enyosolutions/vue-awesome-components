<template>
  <div>
    ...
    <EnyoAjaxTable
      :columns="['col1', 'col2']"
      :rows="[
        { col1: 'qq', col2: 'some data' },
        { col1: 'qq2', col2: 'some moore data' },
        { col1: 'qq3', col2: 'a third data' },
      ]"
    />
  </div>
</template>
...
import EnyoAjaxTable from 'vue-enyo-components/components/table/AwesomeTable.vue';
